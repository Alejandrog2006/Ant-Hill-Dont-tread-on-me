...
int main(int argc, char** argv) {
    ...
    if (all || test == 3) test2_object_destroy();
    ...
    if (all || test == 8) test1_object_set_location();
    if (all || test == 9) test2_object_set_location();
    if (all || test == 10) test1_object_get_location();
    if (all || test == 11) test2_object_get_location();
