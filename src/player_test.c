...
int main(int argc, char** argv) {
    ...
    if (all || test == 2) test1_player_destroy();
    if (all || test == 3) test2_player_destroy();
    ...
    if (all || test == 10) test1_player_get_location();
    if (all || test == 11) test2_player_get_location();
    if (all || test == 12) test1_player_set_health();
    if (all || test == 13) test2_player_set_health();
    if (all || test == 14) test1_player_get_health();
    if (all || test == 15) test2_player_get_health();
