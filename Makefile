...
$(EXE): $(O_DIR)/game_loop.o $(O_DIR)/game.o $(O_DIR)/command.o $(O_DIR)/graphic_engine.o $(O_DIR)/space.o $(O_DIR)/game_actions.o $(O_DIR)/objects.o $(O_DIR)/game_reader.o $(O_DIR)/player.o $(O_DIR)/set.o $(O_DIR)/character.o $(O_DIR)/inventory.o $(O_DIR)/link_l.o $(O_DIR)/game_rules.o
	@$(CC) -o $@ $^ $(LIBS)
...
$(O_DIR)/game_rules.o: $(C_DIR)/game_rules.c $(H_DIR)/game.h $(H_DIR)/game_reader.h $(H_DIR)/types.h
	@$(CC) $(CFLAGS) -o $@ -c $<
	@echo "--> game rules module compiled"
