...
LIBS = -lSDL2 -lSDL2_image -lscreen -L $(R_DIR)

IMAGES = $(R_DIR)/intro_image.png $(R_DIR)/end_image.png

##########  General rules  ##########
all: check_images new_folder $(EXE) space_test set_test character_test inventory_test link_test player_test object_test
